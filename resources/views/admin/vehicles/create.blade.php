<x-dashboard-layout>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-8">
            <h2 class="text-xl font-bold text-secondary mb-6">Tambah Kendaraan Baru</h2>
            <form method="POST" action="{{ route('admin.vehicles.store') }}">
                ...
                <div class="flex gap-3 mt-8">
                    ...
                    <button type="submit" class="flex-1 bg-primary text-white font-bold py-3 rounded-xl hover:bg-blue-700 transition-colors">Simpan Kendaraan</button>
                </div>
            </form>
        </div>
    </div>
